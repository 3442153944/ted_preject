        ...
        <div class="content">
            ...
            <div v-if="video_file" class="progress_box">
                <div class="progress_bar">
                    ...
                    <progress_bar :progress="uploaded_percentage"></progress_bar>
                </div>
            </div>
            ...
            <div class="upload_info" >
                ...
                <div class="submit_btn">
                    <span @click="submit_video">投稿</span>
                </div>
            </div>
        </div>
    </div>
...
const submit_video = async () => {
    ...
    const cover_file = await getImgByte(choose_video_cover.value); // 获取封面图像字节流
   let res=await upload_video(video_file.value,cover_file,video_data);
