...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '22280e92-05be-11ef-ba69-80fa5b5f0ae3:1-435';
...
CREATE TABLE `auth_user` (
  ...
  `avatar_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '用户头像名称',
  ...
  `introduce` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '作者简介',
  `self_website` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '作者个人网站',
  `self_website_introduce` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '作者个人网站简介',
  `user_tags` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '作者头衔/标签',
  `user_status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '用户个人账号状态',
  `top_video` bigint DEFAULT NULL COMMENT '置顶视频ID',
  PRIMARY KEY (`id`),
...
INSERT INTO `auth_user` VALUES (1,'123456','2024-09-25 18:54:08.000000',1,'admin','sun','yuanling','344215394@qq.com',1,1,'2024-09-25 18:55:01.000000',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,'pbkdf2_sha256$720000$CeR10ZAvpNXn0zlRk27TEv$2uUsyXHkd5+caQ3SaY5UxxmYmGIBMPnAvsySQHHFs1s=',NULL,1,'test_user','','','admin@example.com',1,1,'2024-09-25 11:11:21.338294',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(3,'pbkdf2_sha256$720000$jtua63bnd9cpqJmTbuPZmh$BDj3x7Xle5NW/Nl2PafPyZ75kYAG/kyT1bHLPPxfRoc=','2024-09-26 00:43:30.000000',0,'aaa','sun','yuanling','11232@qq.com',1,1,'2024-09-26 00:43:30.000000','956953952044960592652','女','2024-09-26',NULL,NULL,NULL,NULL,NULL,NULL),(4,'pbkdf2_sha256$720000$NiewqXI0clrvACICrXXnks$ruVPGN5GWMhf0AvHlKfEgV7VNOWVVarD5NFeaqcBUbQ=','2024-09-26 15:36:54.000000',0,'testuser','sun','yuanling','123456@aa.com',1,1,'2024-09-26 15:36:54.000000','227708771630839632276','男','2024-09-26','这是一个简单的介绍','https://www.baidu.com','别想那么多，这就是一个百度1','计算机算法专家1',NULL,1);
...
CREATE TABLE `collect_table` (
  ...
  `collect_time` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '视频收藏时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `collect_table` VALUES (3,1,4,'2024-10-01 23:30:01'),(4,2,4,'2024-10-04 21:00:23');
...
CREATE TABLE `comment_interaction` (
  ...
  `comment_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '评论的类型',
  `interaction_time` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '交互的时间',
  `interaction_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '交互类型：like,not_like',
  PRIMARY KEY (`id`)
...
CREATE TABLE `comment_reply_table` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `comment_level` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '评论分级',
  `comment_content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '评论内容',
  `send_user_id` int DEFAULT NULL COMMENT '发送者的ID',
  `reply_comment_id` bigint DEFAULT NULL COMMENT '回复的评论ID',
  `send_time` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '发送的时间',
...
CREATE TABLE `comment_table` (
  ...
  `comment_content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '评论内容',
  `comment_level` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '评论等级，0主，1副',
  `reply_comment_id` bigint DEFAULT NULL COMMENT '回复的主评论的id，主评论时为空',
  `send_time` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '评论发送的时间',
...
INSERT INTO `comment_table` VALUES (1,4,'主评论测试','0',NULL,'2024-9-27 15:23:14',1),(2,4,'主评论测试','0',NULL,'2024-9-27 15:23:46',1),(7,4,'主评论发送测试','0',NULL,'2024-09-30 16:16:12',1),(8,4,'测试','0',NULL,'2024-10-04 21:00:29',2);
...
CREATE TABLE `like_table` (
  ...
  `like_time` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `like_table` VALUES (3,1,4,'2024-10-01 23:30:02'),(4,2,4,'2024-10-04 21:00:23');
...
CREATE TABLE `video_info` (
  ...
  `introduce` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '视频简介',
  `create_time` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '视频上传时间',
  `tags` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '视频相关标签',
  `video_file_path` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '视频文件所在路径',
  `video_status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '视频目前状态',
  `video_cover_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '视频封面文件路径',
  PRIMARY KEY (`id`)
...
INSERT INTO `video_info` VALUES (1,'测试视频一','testuser',4,'这是一个简单的视频简介','2024-9-27 15:55:12','游戏,实况,核爆','v1.mp4','1','102718099_p0.png'),(2,'测试视频二','testuser',4,'这是第二个简单的测试视频','2024-10-4 20:41:32','微信小程序','v2.mp4','1','102718099_p0.png');
...
CREATE TABLE `watch_table` (
  ...
  `watch_time` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '观看视频的时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `watch_table` VALUES (1,1,4,'2024-10-01 17:32:57'),(2,2,4,'2024-10-04 21:59:58');
...
-- Dump completed on 2024-10-05 22:24:17
